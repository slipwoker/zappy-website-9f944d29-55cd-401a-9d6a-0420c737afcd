document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!isValid) {
        e.preventDefault();
        const firstError = contactForm.querySelector('[aria-invalid]');
  ...
  if (animatedElements.length > 0) {
    ...
    style.textContent = '.visible.animated{opacity:1!important;transform:translateY(0)!important}';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9f944d29-55cd-401a-9d6a-0420c737afcd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9f944d29-55cd-401a-9d6a-0420c737afcd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9f944d29-55cd-401a-9d6a-0420c737afcd';
